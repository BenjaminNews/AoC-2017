...
public class AdventOfCodeDaySeven {
    ...
    private ArrayList<String> supporting = new ArrayList<>();
    ...
    public static void main(String[] args) {
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Disc disc = new Disc();
                disc.setName(name);
                disc.setWeight(Integer.parseInt(weight));
                discs.add(disc);
            }
            br.close();
            for (String s : lines) {
            ...
            for (int i = 0; i < mismatchedWeight.size(); i++) {
                ...
                if (hasChildren == false) {
                    ...
                    System.out.println("PARENT: " + offBalance.getWeight());
                    int temp = 0;
                    for (Disc disc : offBalance.getChildren()) {
                        System.out.println("individual " + disc.getChildren());
                    }
                }
            }
        } catch (Exception e) {
