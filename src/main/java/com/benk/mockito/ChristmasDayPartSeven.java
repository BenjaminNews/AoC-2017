...
public class ChristmasDayPartSeven {

    private static String dummyData = "una bokpr ftz ryw nau yknf fguaczl anu\n" +
    ...
    public static void main(String[] args) {
        ChristmasDayPartSeven christmasDayPartSeven =  new ChristmasDayPartSeven();

        System.out.println(christmasDayPartSeven.getRepeatingPhrases(dummyData));
    }


    public int getRepeatingPhrases(String passphrases) {
...
//            String checkMeForRepeats = lines[i];
//            ArrayList ourPhrases = new ArrayList<String>();
//            for(String s : checkMeForRepeats.split(" ")) {
//                if(!ourPhrases.contains(s)) {
//                    ourPhrases.add(s);
//                } else if (ourPhrases.contains(s)) {
//                    System.out.println("our repeated word: '" + s+ "'");
//                    repeats++;
//                }
//            }
//        }

        for(String s : passphrases.split("\n")) {
