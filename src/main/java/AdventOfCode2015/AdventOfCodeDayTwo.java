...
public class AdventOfCodeDayTwo {
    ...
    private int bowLenght = 0;
    private int wrappingPaperSize = 0;

    public void calculateRequiredWrappingPaper(String input) {
        String[] measurements = input.split("\n");

        for(String s : measurements) {
            String[] lengths = s.split("x");
    ...
    private int getSmallestArea(int x, int y, int z) {
        int[] sizes = new int[] {x, y, z};
        Arrays.sort(sizes);
        return sizes[0] * sizes[1];
    }

    private int calculateBowLength(int x, int y, int z) {
        int[] sizes = new int[] {x, y, z};
        Arrays.sort(sizes);
        return (sizes[0] + sizes[0] + sizes[1] + sizes[1]) + (sizes[0] * sizes[1] * sizes[2]);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("required wrapping paper: " + adventOfCodeDayTwo.getWrappingPaperSize());
        System.out.println("required ribbon: " + adventOfCodeDayTwo.getBowLenght());
    }

    private static final String input = "3x11x24\n" +
            "13x5x19\n" +
            "1x9x27\n" +
            "24x8x21\n" +
            "6x8x17\n" +
