...
public class AdventOfCodeDayThree {
    ...
    public int deliverPresents(String input) {
        housesVisited.add(String.valueOf(xPositionSanta) + "-" + String.valueOf(yPositionSanta));

        for(char c : input.toCharArray()) {
            moveSanta(c);
            if(!housesVisited.contains(String.valueOf(xPositionSanta) + "-" + String.valueOf(yPositionSanta))) {
                housesVisited.add(String.valueOf(xPositionSanta) + "-" + String.valueOf(yPositionSanta));
            }
        }
    ...
    private void moveRobotSanta(char c) {
        if(c == '^') {
            yPositionRobotSanta++;
        } else if(c == '>') {
            xPositionRobotSanta++;
    ...
    public int deliverPresentsPartTwo(String input) {
        housesVisited.add(String.valueOf(xPositionSanta) + "-" + String.valueOf(xPositionRobotSanta));
        ...
        for(int i = 0; i < moves.length; i++ ) {
            if(i % 2 == 0) {
                ...
                moveRobotSanta(moves[i]);
                if (!housesVisited.contains(String.valueOf(xPositionRobotSanta) + "-" + String.valueOf(yPositionRobotSanta))) {
                    housesVisited.add(String.valueOf(xPositionRobotSanta) + "-" + String.valueOf(yPositionRobotSanta));
                }
            }
        }
        return housesVisited.size();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("number of houses visited: " + result);

        adventOfCodeDayThree = new AdventOfCodeDayThree();

        int resultPartTwo = adventOfCodeDayThree.deliverPresentsPartTwo(input);
        System.out.println("number of houses getting presents: " + resultPartTwo);
