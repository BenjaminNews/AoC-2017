...
public class AdventOfCodeDaySix {
    ...
    private void turnLightsOff(int startRangeX, int startRangeY, int endRangeX, int endRangeY) {
        for(int x = startRangeX; x <= endRangeX; x++) {
            for(int y = startRangeY; y <= endRangeY; y++) {
                lightGrid[x][y] = 0;
            }
    ...
    private void toggleLights(int startRangeX, int startRangeY, int endRangeX, int endRangeY) {
        for(int x = startRangeX; x <= endRangeX; x++) {
            for(int y = startRangeY; y <= endRangeY; y++) {
