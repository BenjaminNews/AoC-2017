...
public class AdventOfCodeDaySeven {
    ...
    private static final String inputTwo = "agxxvohnbvmcjufyjdk[qlqeonouztkfircb]wggnpwpnjbhmdsdy[omrwycukclrnonoo]cqfgbcjzejfbiozco\n" +
    ...
    private static final String inputThree = "finznvwrtmxdkynqq[znzojlzkdfoyeqkb]fnjmchixkxmxnyb\n" +
    ...
    private static final String inputFour = "eqctvrzmizmzadiv[nfkcjhlffxwichh]owulkigprckljfa[xwiexfzduspgkmamyz]dslflydyueutucbz\n" +
