...
public class AdventOfCodeDayFive {
    ...
    public int performMovePartTwo() {
        while(index < trampolineValues.length) {
            int jumps = trampolineValues[index];
            trampolineValues[index] += jumps >= 3 ? -1 : 1;
            index += jumps;
            steps++;
        }
        return steps;
    ...
    public static void main(String[] args) {
        ...
        adventOfCodeDayFive.setup(inputValues);
        System.out.println(adventOfCodeDayFive.performMovePartOne());

        adventOfCodeDayFive = new AdventOfCodeDayFive();
        adventOfCodeDayFive.setup(inputValues);
        System.out.println(adventOfCodeDayFive.performMovePartTwo());
    }
