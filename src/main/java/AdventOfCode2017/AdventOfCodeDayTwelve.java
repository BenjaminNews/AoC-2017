...
public class AdventOfCodeDayTwelve {
    ...
    private HashMap<Integer, List<Integer>> pipes = new HashMap();
    ...
    public int getConnections(int pipeNumber) {
        List<Integer> initialAssociatedValues = pipes.get(pipeNumber);
        for(int i = 0; i < initialAssociatedValues.size(); i++) {
            List<Integer> checkMoreValue = pipes.get(initialAssociatedValues.get(i));
    ...
    public int getConnectionsTwo() {
        int groupsCount = 0;
        while(pipes.size() > 0) {
            List<Integer> initialAssociatedValues = pipes.get(getLowestValueKey());
            for (int i = 0; i < initialAssociatedValues.size(); i++) {
                List<Integer> checkMoreValue = pipes.get(initialAssociatedValues.get(i));
                for (int x = 0; x < checkMoreValue.size(); x++) {
                    int newValue = checkMoreValue.get(x);
            ...
            reduceList(initialAssociatedValues);
            groupsCount++;
        }
        return groupsCount;
    }

    private void reduceList(List<Integer> reduceList) {
        for(int i : reduceList) {
            pipes.remove(i);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("result: " + adventOfCodeDayTwelve.getConnectionsTwo());
    }
